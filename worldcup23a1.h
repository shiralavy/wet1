...
private:
    ...
    AVLtree<ready_team> m_tree_ready_teams; //AVL tree containing all of the teams in the tournament that are ready to playe (have 11 players, one of them is a goalie) sorted by id
